...
class FreeTrialUpgradeOfferORM(BaseModel):
    ...
    target_package_id: Mapped[int | None] = mapped_column(Integer, nullable=True)
...
class FreeTrialUpgradeORM(BaseModel):
    ...
    vpn_key_id: Mapped[int] = mapped_column(Integer, nullable=False, index=True)
    ...
    target_package_id_snapshot: Mapped[int | None] = mapped_column(Integer, nullable=True)
